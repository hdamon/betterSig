function [HDR, immediateReturn] = EDF(HDR,CHAN,MODE,ReRefMx) 
   immediateReturn = false; % Default Value

% betterSig.loadHeader.EDF
%
%
% HDR = EDF(HDR,CHAN,MODE,ReRefMx) 
%
%
...
%% EDF/GDF/BDF File
  ...
  if any(HDR.FILE.PERMISSION=='r')
    ...
    HDR.EVENT.SampleRate = HDR.SampleRate;
    HDR = edfannot2evt(HDR,CHAN,MODE,ReRefMx);
  ...
  elseif any(HDR.FILE.PERMISSION=='w');                %%%%%%% ============= WRITE ===========%%%%%%%%%%%%
    ...
    if (HDR.NS>0),	% header 2
      ...
      HDR = physicalunits(HDR,CHAN,MODE,ReRefMx);
